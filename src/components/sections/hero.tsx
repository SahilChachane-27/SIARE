    ...
    <section id="hero" className="relative min-h-screen flex flex-col items-start justify-center overflow-hidden bg-primary pt-24 md:pt-32">
      ...
      <div className="container mx-auto px-6 md:px-16 lg:px-32 relative z-10">
        <div className="relative z-10 max-w-4xl" data-aos="fade-right">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight mb-6 drop-shadow-2xl font-headline text-white leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-start">
            <Button asChild size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground transition-all duration-300 ease-in-out hover:scale-105 rounded-funky px-8 py-6 text-sm md:text-base font-bold shadow-xl w-full sm:w-auto">
              <Link href="/contact">Start Your University Journal</Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="border-accent text-white bg-transparent hover:bg-accent hover:text-accent-foreground transition-all duration-300 ease-in-out hover:scale-105 rounded-funky px-8 py-6 text-sm md:text-base font-bold shadow-xl w-full sm:w-auto">
