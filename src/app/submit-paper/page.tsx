...
const formSchema = z.object({
  ...
  aboutConference: z.string().min(5, "Please provide some details about your conference or research paper."),
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            <div className="space-y-6 md:space-y-8">
              ...
              <p className="max-w-5xl mx-auto text-sm sm:text-lg md:text-xl text-white/90 font-medium italic">
                Empowering authors and institutions with professional publishing technology.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto max-w-4xl">
            <div className="bg-white p-6 md:p-12 rounded-funky shadow-2xl border border-border/50">
              <div className="text-center mb-10">
                <h2 className="text-2xl sm:text-3xl font-bold text-primary font-headline italic">Submission Inquiry Form</h2>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-base font-bold text-primary">About Paper / Conference <span className="text-destructive">*</span></FormLabel>
                        <FormControl>
                          <Textarea 
                            placeholder="Briefly describe your research paper or conference goals..." 
