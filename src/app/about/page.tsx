          ...
          <div className="container mx-auto px-8 md:px-16 lg:px-32">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {whatWeDo.map((item, idx) => (
                <Card key={idx} className="border-none shadow-xl rounded-funky bg-slate-50 p-8 hover:bg-white hover:-translate-y-1 transition-all duration-300 group" data-aos="fade-up" data-aos-delay={idx * 100}>
                  <div className="flex gap-6">
                    <div className="h-14 w-14 rounded-funky bg-primary flex items-center justify-center shrink-0 group-hover:bg-accent transition-colors">
                      <item.icon className="h-7 w-7 text-white" />
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-primary mb-2 italic">{item.title}</h3>
