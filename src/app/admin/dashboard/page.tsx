        ...
        <div className="container mx-auto px-4 md:px-8 max-w-7xl">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16">
            <div className="space-y-3">
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-3xl md:text-4xl font-black text-primary font-headline italic">
                  SIARE Admin Portal
                </h1>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <Card className="lg:col-span-2 rounded-2xl border-none shadow-xl bg-white overflow-hidden">
              <CardHeader className="border-b border-slate-50 bg-white/50 px-8 py-8">
                <div className="flex justify-between items-center">
                  <div>
                    <CardTitle className="text-2xl font-bold text-primary font-headline italic flex items-center gap-3">
                ...
                {recentLoading ? (
                  ...
                  <div className="divide-y divide-slate-50">
                    {recentJournals.map((journal: any) => (
                      <div key={journal.id} className="px-8 py-8 flex items-center gap-8 hover:bg-slate-50/50 transition-colors group">
                        <div className="h-16 w-16 rounded-xl bg-secondary/50 flex items-center justify-center shrink-0 overflow-hidden relative shadow-inner">
                          {journal.imageUrl ? (
                        ...
                        <div className="text-right shrink-0">
                          <div className="text-[10px] font-black text-primary/30 uppercase tracking-widest mb-3">
                            {journal.createdAt?.seconds ? new Date(journal.createdAt.seconds * 1000).toLocaleDateString() : 'Just now'}
                          </div>
                          <div className="flex items-center justify-end gap-4">
                            <Button asChild size="sm" variant="ghost" className="h-8 px-4 text-[10px] font-black uppercase text-primary/60 hover:text-accent hover:bg-transparent">
                              <Link href={`/admin/journals?edit=${journal.id}`}>Edit</Link>
                            </Button>
                            <Button asChild size="sm" variant="ghost" className="h-8 px-4 text-[10px] font-black uppercase text-accent hover:text-primary hover:bg-transparent">
            ...
            <div className="space-y-10">
              ...
              <Card className="rounded-2xl border-none shadow-xl bg-primary text-white p-10 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/60 text-xs mb-10 leading-relaxed font-medium italic">
                    Configure upcoming conferences, symposiums, and institutional workshops for the SIARE network.
                  </p>
                  <Button asChild className="w-full bg-accent text-primary font-black uppercase text-[11px] tracking-widest rounded-xl hover:scale-[1.02] transition-transform shadow-xl h-14">
              ...
              <Card className="rounded-2xl border-none shadow-xl bg-white p-10 relative overflow-hidden group border border-slate-100">
                <div className="relative z-10">
                  <h3 className="text-xl font-bold text-primary font-headline italic mb-3 flex items-center gap-3">
                    <History className="h-6 w-6 text-accent" />
                    Past Records
                  </h3>
                  <p className="text-muted-foreground text-[11px] mb-8 leading-relaxed font-medium uppercase tracking-tighter italic">
              ...
              <Card className="rounded-2xl border-none shadow-xl bg-white p-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-5 rounded-xl bg-amber-50 border border-amber-100 flex gap-4">
              ...
              {/* Utility Tools */}
              <Card className="rounded-2xl border-none shadow-xl bg-white p-10">
                <h3 className="text-base font-bold text-primary font-headline italic mb-8">Quick Utilities</h3>
