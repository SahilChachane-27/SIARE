      ...
      <main className="flex-1">
        <section className="relative overflow-hidden bg-primary text-white pt-32 pb-24">
          ...
          <div className="container mx-auto px-4 md:px-8 lg:px-12 relative z-10 text-center">
            ...
            <p data-aos="fade-up" data-aos-delay="100" className="text-base md:text-xl text-white/80 max-w-2xl mx-auto mb-12">
            ...
            <div data-aos="fade-up" data-aos-delay="200" className="inline-flex bg-white/10 p-1 rounded-funky border border-white/20 shadow-2xl">
              <button 
                ...
                className={`px-6 sm:px-10 py-3 rounded-funky transition-all font-black text-xs sm:text-sm tracking-widest ${currency === 'USD' ? 'bg-accent text-accent-foreground shadow-lg' : 'text-white/70 hover:text-white'}`}
              >
                $ USD
              </button>
              <button 
                onClick={() => setCurrency('INR')}
                className={`px-6 sm:px-10 py-3 rounded-funky transition-all font-black text-xs sm:text-sm tracking-widest ${currency === 'INR' ? 'bg-accent text-accent-foreground shadow-lg' : 'text-white/70 hover:text-white'}`}
              >
                ₹ INR
              </button>
            </div>
          ...
          <div className="container mx-auto px-4 md:px-8 lg:px-12">
            ...
            <div className="mt-20 md:mt-24">
              <div data-aos="fade-up" className="relative p-[2px] rounded-funky overflow-hidden group shadow-2xl">
                ...
                <div className="relative bg-white rounded-funky p-6 md:p-12 flex flex-col md:flex-row items-center justify-between text-center md:text-left gap-8 md:gap-12 h-full">
