                ...
                {contactEmails.map((item, i) => (
                  <Card key={i} className="rounded-2xl border border-primary/5 shadow-xl bg-slate-50 hover:bg-white transition-all group" data-aos="fade-up" data-aos-delay={i * 100}>
                    <CardContent className="p-8 flex flex-col items-center text-center">
                      ...
                      <a href={item.link} className="text-xs text-accent font-black break-all hover:text-primary transition-colors underline decoration-accent/20 underline-offset-4">
                        {item.email}
                      </a>
                    </CardContent>
                  </Card>
            ...
            <div className="mb-20">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {helpdesks.map((help, i) => (
                  <Card key={i} className="rounded-2xl border border-primary/5 shadow-lg p-8 bg-white hover:shadow-xl transition-all" data-aos="fade-up" data-aos-delay={i * 100}>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="rounded-2xl border-none shadow-2xl bg-slate-50 p-10" data-aos="fade-up">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:collaborations@academicproceeding.org" className="text-sm font-black text-primary hover:text-accent transition-colors">collaborations@academicproceeding.org</a>
                </div>
              </Card>
              ...
              <Card className="rounded-2xl border-none shadow-2xl bg-slate-50 p-10" data-aos="fade-up" data-aos-delay="100">
                ...
                <div className="flex items-center gap-3">
                  <Mail className="h-5 w-5 text-accent" />
                  <a href="mailto:feedback@academicproceeding.org" className="text-sm font-black text-primary hover:text-accent transition-colors">feedback@academicproceeding.org</a>
                </div>
              </Card>
            </div>
              ...
              <div className="flex justify-center gap-6">
                {[
                  ...
                  <button key={i} className="group flex flex-col items-center gap-2">
                    <div className="h-14 w-14 rounded-full bg-slate-100 flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-all shadow-md">
                      <social.icon className="h-6 w-6" />
                    </div>
                    <span className="text-[10px] font-black uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity text-primary">{social.name}</span>
                  </button>
                ))}
              </div>
            </div>
